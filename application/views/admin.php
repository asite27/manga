...
<head>
  ...
  <!-- Icon Font Css -->
  <link rel="stylesheet" href="<?=BASE_URL();?>plugins/icofont/icofont.min.css"/>
  <!-- Slick Slider  CSS -->
...
<header>
	<div class="header-top-bar">
		...
		<nav class="navbar navbar-expand-lg navigation" id="navbar">
			<div class="container">
				 <a class="navbar-brand" href="http://localhost/manga/controllersadmin/">
			  ...
			  <div class="collapse navbar-collapse" id="navbarmain">
				<ul class="navbar-nav ml-auto">
				  <li class="nav-item active">
					<a class="nav-link" href="http://localhost/manga/controllersadmin/">Home</a>
				  </li>
				   <li class="nav-item"><a class="nav-link" href="http://localhost/manga/controlabt/abt">About</a></li>
					<li class="nav-item"><a class="nav-link" href="http://localhost/manga/controllersadmin/servis">Services</a></li>
				</ul>
			  </div>
			</div>
		</nav>
				...
				<div class="feature-block d-lg-flex">
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<ul class="w-hours list-unstyled">
		                    ...
		                    <li class="d-flex justify-content-between">Thu - Fri : <span>8:30 - 17:00</span></li>
...
<footer class="footer section gray-bg">
	<div class="container">
		...
		<div class="footer-btm py-4 mt-5">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6">
					<div class="copyright">
						&copy; Copyright Reserved to <span class="text-color">Novena</span> by <a href="<?=BASE_URL();?>https://themefisher.com/" target="_blank">Themefisher</a>
					</div>
				</div>
				<div class="col-lg-6">
    ...
    <script src="<?=BASE_URL();?>plugins/counterup/jquery.easing.js"></script>
    <!-- Slick Slider -->
    ...
    <script src="<?=BASE_URL();?>https://maps.googleapis.com/maps/api/js?key=AIzaSyAkeLMlsiwzp6b3Gnaxd86lvakimwGA6UA&callback=initMap"></script>    
